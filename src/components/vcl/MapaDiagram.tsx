import mapa640 from "@/assets/imagens/metodo-mapa-v3-640.webp";
import mapa960 from "@/assets/imagens/metodo-mapa-v3-960.webp";
import mapa1440 from "@/assets/imagens/metodo-mapa-v3-1440.webp";
...
export function MapaDiagram() {
  return (
    <div className="relative left-1/2 my-8 w-screen -translate-x-1/2 md:static md:my-12 md:w-full md:max-w-[1100px] md:translate-x-0">
      <img
        src={mapa960}
        srcSet={`${mapa640} 640w, ${mapa960} 960w, ${mapa1440} 1440w`}
